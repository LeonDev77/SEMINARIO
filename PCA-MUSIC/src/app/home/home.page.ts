...
export class HomePage implements OnInit {
  ...
  cantantes: sliderBasic[] = [
    {
      name: 'Daddy Yankee',
      image: 'https://i.pinimg.com/1200x/fe/bb/ed/febbed7ad13efee48025fcc6f9d99f11.jpg',
    ...
    {
      name: 'Ed Sheeran',
      image: 'https://i.pinimg.com/1200x/4b/7b/c9/4b7bc96c63cb960f1ae5eaac08cec28f.jpg',
    ...
    {
      name: 'Feid',
      image: 'https://i.pinimg.com/736x/fc/4d/6c/fc4d6caceaee5b6a5f58025bce133357.jpg',
    ...
    {
      name: 'Diomedes Díaz',
      image: 'https://i.pinimg.com/736x/36/56/1b/36561b14113bf01d5e96c2d57a66f5c6.jpg',
  ...
  async removeStorage() {
    await this.storageService.remove('colorM');
    await this.storageService.remove('iconM');
    await this.storageService.remove('cardM');
  }
